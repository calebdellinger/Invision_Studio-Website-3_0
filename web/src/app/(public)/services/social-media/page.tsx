  ...
  return (
    <>
      ...
      <div className="mx-auto w-full max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        <header className="max-w-4xl border-b border-black/[0.06] pb-12">
          <p className="text-[11px] font-medium uppercase tracking-[0.28em] text-[var(--brand-creative)]">
            Social media management
          </p>
          <h1 className="mt-4 text-4xl leading-[1.1] font-semibold tracking-tight text-zinc-900 [font-family:var(--font-fraunces)] sm:text-5xl">
        ...
        <section className="pt-14">
          <div className="max-w-3xl">
            <h2 className="text-3xl font-semibold tracking-tight text-zinc-900 [font-family:var(--font-fraunces)] sm:text-4xl">
              Why does it matter?
            </h2>
            <p className="mt-4 text-sm leading-relaxed text-zinc-600">
        ...
        <section className="pt-14">
          ...
          <ul className="mt-8 grid gap-4 md:grid-cols-3">
            <li className="rounded-2xl border border-black/[0.08] bg-white/85 p-6 ring-1 ring-inset ring-black/[0.03]">
        ...
        <section className="pt-14">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            <Link
              ...
              className="rounded-xl border border-black/[0.08] bg-white/80 p-5 ring-1 ring-inset ring-black/[0.03] transition-[border-color,transform] hover:-translate-y-0.5 hover:border-[color-mix(in_srgb,var(--brand-creative)_35%,transparent)]"
            >
